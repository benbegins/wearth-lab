...
})({"dfKIC":[function(require,module,exports) {
...
let menu;
const init = ()=>{
    (0, _swiperDefault.default)();
    (0, _animationDefault.default)();
    const loco = new (0, _locomotiveScrollDefault.default)({
        el: document.querySelector("[data-scroll-container]"),
        smooth: true
    });
    menu = new (0, _menuDefault.default)(loco);
};
// Vue app
// Vue.createApp(App).mount("#page")
// window.addEventListener("DOMContentLoaded", init)
// window.addEventListener("pageshow", init)
window.addEventListener("load", init) // window.addEventListener("popstate", init)
 // init()
;

},{"../scss/style.scss":"kxOFu","./App.vue":"4bpvn","./components/swiper":"gigjp","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU","locomotive-scroll":"cmx8k","./components/animation":"zHN8G","./components/menu":"cqNLB"}],"kxOFu":[function() {},{}],"4bpvn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("d6b4c00517e2db");
    if (script.__esModule) script = script.default;
    require("acee425a6e0c40ed").default(script);
    script.__scopeId = "data-v-2738a9";
    script.__file = "/Users/benoit/Web/wearth-lab/app/public/wp-content/themes/wearth-lab/src/js/App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "2738a9-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("2738a9-hmr", script)) __VUE_HMR_RUNTIME__.reload("2738a9-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"d6b4c00517e2db":"5SGZ8","acee425a6e0c40ed":"3EvoI","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"5SGZ8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _locomotiveScroll = require("locomotive-scroll");
var _locomotiveScrollDefault = parcelHelpers.interopDefault(_locomotiveScroll);
exports.default = {
    ...
    methods: {
        ...
        toggleSubMenu (cat) {
            switch(cat){
                case "femme":
                    if (this.menuFemmeActive) // Desactive menu
                    this.closeSubMenu();
                    else {
                        // Active menu
                        this.closeSubMenu();
                    ...
                    break;
                case "homme":
                    if (this.menuHommeActive) // Desactive menu
                    this.closeSubMenu();
                    else {
                        // Active menu
                        this.closeSubMenu();
                    ...
                    break;
                case "search":
                    if (this.menuSearch) // Desactive menu
                    this.closeSubMenu();
                    else {
                        // Active menu
                        this.closeSubMenu();
                        ...
                        this.bodyOverflow(true);
                        const input = document.querySelector(".search-menu input[type=text]");
                        setTimeout(()=>{
                            input.focus();
                        }, 250);
                    }
        ...
        initLocoScroll () {
            this.locoScroll = new (0, _locomotiveScrollDefault.default)({
                el: document.querySelector("[data-scroll-container]"),
                smooth: true
            });
            this.menuSticky();
        ...
        menuSticky () {
            ...
            this.locoScroll.on("scroll", (e)=>{
                if (e.scroll.y > 75) menu.classList.add("is-scrolling");
                else menu.classList.remove("is-scrolling");
            });
        }
    }
};

},{"locomotive-scroll":"cmx8k","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"cmx8k":[function(require,module,exports) {
...
},{}],"3EvoI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"gigjp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const swiper = ()=>{
    // Slider products
    const swiperListProducts = new (0, _swiperDefault.default)(".swiper-list-products", {
        speed: 400,
        slidesPerView: "auto",
        breakpoints: {
            1024: {
    ...
    // Slider Marques
    const swiperListMarques = new (0, _swiperDefault.default)(".swiper-list-marques", {
        speed: 400,
        slidesPerView: "auto",
        navigation: {
    ...
    if (listMarques) {
        ...
        function arrowsPosition() {
            const height = listMarques.querySelector(".img-container").offsetHeight;
    ...
    const swiperGalleryProduct = new (0, _swiperDefault.default)(".swiper-gallery-product", {
        speed: 600,
        slidesPerView: "auto",
        navigation: {
            nextEl: ".swiper-button-next",
...
},{"../../shared/create-shadow.js":"hlJwE","../../shared/effect-init.js":"TURXR","../../shared/effect-target.js":"76dEO","../../shared/effect-virtual-transition-end.js":"86Sfl","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"ibMwU":[function() {},{}],"zHN8G":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const animation = ()=>{
    ...
    if (introReveal) {
        ...
        if (lines) lines.forEach((line, index)=>{
            const reveal = line.querySelector(".reveal-element");
            const delay = index * 0.15;
            (0, _gsapDefault.default).defaults({
                duration: 1.5,
                ease: "power4.out"
            });
            (0, _gsapDefault.default).to(reveal, {
                yPercent: -100,
                delay: delay
            });
        });
...
},{"gsap":"33IqQ","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"33IqQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"gljYa","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"cqNLB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Menu {
    constructor(loco){
    ...
    toggleSubMenu(btn) {
        if (btn) {
            ...
            this.submenus.forEach((submenu)=>{
                if (submenu.getAttribute("data-submenu") !== submenuName) submenu.classList.remove("active");
            });
            ...
            let isActive = false;
            for(let i = 0; i < this.submenus.length; i++)if (this.submenus[i].classList.contains("active")) {
                isActive = true;
                break;
            }
            if (isActive) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["dfKIC","lFcwH"], "lFcwH", "parcelRequire3b99")
