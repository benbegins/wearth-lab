...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-B60WL2TNWE"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-B60WL2TNWE');
    </script>
</head>
...
<div id="page" class="site" data-scroll-container>
    ...
    <header class="site-header">
        <!-- Logo -->
        <div class="logo" :class="{active: menuSearch}">
            <a href="<?= get_site_url() ?>">
                <svg class="logo__svg" xmlns="http://www.w3.org/2000/svg" width="123.534" height="116.065" viewBox="0 0 123.534 116.065">
                    <g id="Groupe_80" data-name="Groupe 80" transform="translate(-542.863 1972.58)">
                        <g id="Groupe_72" data-name="Groupe 72" transform="translate(581.399 -1943.757)" class="logo__icone">
                        ...
                        <g id="Groupe_73" data-name="Groupe 73" transform="translate(542.863 -1910.578)" class="hide-on-scroll">
                        ...
                        <g id="Groupe_74" data-name="Groupe 74" transform="translate(649.696 -1910.578)" class="hide-on-scroll">
                        ...
                        <g id="Groupe_76" data-name="Groupe 76" transform="translate(543.993 -1972.58)" class="hide-on-scroll">
                        ...
                        <g id="Groupe_78" data-name="Groupe 78" transform="translate(553.836 -1893.725)" class="hide-on-scroll">
        ...
        <div class="container">
            ...
            <div class="sub-menu header-menu" :class="{active: menuFemmeActive}">
                <div class="header-menu__container">
                    ...
                    <button class="header-menu__btn-close" @click="closeMenu">Fermer</button>
                    <p class="header-menu__title">Femme</p>
                    <ul class="header-menu__list">
                        <li class="header-menu__item">
                            <a href="<?= get_site_url() ?>/categorie-produit/femme">Tous les articles femme</a>
                        </li>
                        <?php
                        // Récupère les terms enfants de la catégorie parent femme
                        $cat_parent = get_term_by( 'slug', 'femme', 'product_cat');
                        $args = [
                        ...
                        foreach($list_cat_femme as $category):
                        ?>
                        <li class="header-menu__item">
                    ...
                    <!-- desktop -->
                    <div class="header-menu__img-container">
                        <p class="header-menu__img-title">Femme</p>
                        <img src="<?= get_template_directory_uri() ?>/src/img/cat-femme.jpg" alt="Mode Femme" class="header-menu__img">
                    </div>
                </div>
            </div>
            ...
            <div class="sub-menu header-menu" :class="{active: menuHommeActive}">
                <div class="header-menu__container">
                    <button class="header-menu__btn-back" @click="closeSubMenu">Retour</button>
                    <button class="header-menu__btn-close" @click="closeMenu">Fermer</button>
                    <p class="header-menu__title">Homme</p>
                    <ul class="header-menu__list">
                        <li class="header-menu__item">
                            <a href="<?= get_site_url() ?>/categorie-produit/homme">Tous les articles homme</a>
                        </li>
                        <?php
                        // Récupère les terms enfants de la catégorie parent femme
                        $cat_parent = get_term_by( 'slug', 'homme', 'product_cat');
                        $args = [
                            "taxonomy" => "product_cat",
                            "parent" => $cat_parent->term_id,
                            "orderby" => "name",
                    ...
                    <!-- desktop -->
                    <div class="header-menu__img-container">
                        <p class="header-menu__img-title">Homme</p>
                        <img src="<?= get_template_directory_uri() ?>/src/img/cat-homme.jpg" alt="Mode Homme" class="header-menu__img">
                    </div>
                </div>
            </div>
        ...
        <!-- overlay -->
        <div class="overlay" ref="bodyOverlay" @mouseover="closeSubMenu" @click="closeSubMenu"></div>
